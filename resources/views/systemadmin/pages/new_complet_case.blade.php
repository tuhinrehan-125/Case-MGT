        ...
        <div class="row">
         ...
         <div class="col-lg-12 col-12">
            ...
            <!-- /.card-header -->
                <!---===============================Filtering===============================================--->
                <div class="card-header text-center">
                    <form action="{{route('systemadmin.search_case_complet')}}" method="POST">
                        {{csrf_field()}}
                        <div class="form-row">
                            <div class="col">
...
{{--               <div class="card-header">
               ...
               <div class="row">
                <div class="col-lg-2">
--}}{{--                <form action="{{route('systemadmin.search_case')}}" method="GET">
            ...
            <div class="card-body">
                ...
                <form action="{{route('systemadmin.caseforward')}}" method="POST">
                    {{csrf_field()}}
                    <button type="submit" class="btn btn-sm btn-danger" name="buttton" value="forward">Forward All &nbsp; <i class="fa fa-forward" aria-hidden="true"></i></button>
                    &nbsp;
            ...
            <div class=" table-responsive">
              <table id="" class="table table-bordered table-striped example1ddd">
                ...
                <tbody>
                @foreach($newcasecomplet as $data)
                <tr>
                  ...
                  <td>
                     <table>
						<tr>
							<td>
	                    		<a href="" class="btn btn-sm btn-outline-secondary" data-toggle="modal" data-target=".exampleModaledit{{$data->id}}"><!-- <i class="fas fa-pencil-alt"> -->
                              </i> Correction
	                    		</a>
							</td>
	                    	<td>
...
{{--                                                  <select class="form-control" name="id_mp" >
                                                  ...
                                                  <select class="form-control select2bs4" name="id_mp" style="width: 100%;">
                                                      <option selected="selected" >Select Mp Name</option>
                                                      @forelse(\App\addmp_model::all() as $mp)
