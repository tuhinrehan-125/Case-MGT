                    ...
                    <div class="col-lg-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="#" id="forward_case_form" method="case">
                                    {{csrf_field()}}
                                    {{method_field('PATCH')}}
                                    <button  class="btn btn-sm btn-danger" disabled id="forward-btn" name="buttton" value="forward">
...
{{--                                        Print &nbsp; <i class="fa fa-print" aria-hidden="true"></i></button>--}}
                                    ...
                                    @include('unitauth.sub-admin.completecase-table')
                                    </div>
                            </div>
                        </div>
                    </div>
    ...
    function checkAll(ele) {
     ...
     $(document).ready(function(){
        ...
        function display(){
            ...
            $("#newcase-complete-subadmin tbody").css("opacity", ".5");
    }
        function removePre(){
        ...
        function datatable(){
            $("#newcase-complete-subadmin").DataTable({
                pageLength: 50,
                "paging":   false,
                dom: 'Bfrtip',
                buttons: [
