  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
           <h1 class="m-0 text-red"><i class="fas fa-user-plus"></i> Office Admin</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active"><i class="fas fa-user-plus"></i> Office Admin</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="card card-success card-outline">
                <div class="card-header">
                    <h3 class="card-title text-bold">
                      <i class="fas fa-user-plus mr-1"></i>Office Admin</b>
                    </h3>
                </div>
                <div class="card-body">
                     <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.sadminregister') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-success">
                                    <i class="fas fa-user-plus"></i> Add Office Admin
                                </button>
                            </div>
                        </div>
                    </form>
                            ...
                            <div class="modal-dialog modal-md">
                              <div class="modal-content">
                                      <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Edit MP ( Ba Number : {{$data->banumber}})</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                          <span aria-hidden="true">&times;</span>
                                        </button>
                                      </div>
                                      <div class="modal-body">
                                        <form action="{{route('admin.deskuser_update',$data->id)}}" method="POST">
                                          {{csrf_field()}}
                                          {{method_field('PATCH')}}
                                          <div class="form-group">
                                            <label for="recipient-name" class="col-form-label">Desk Admin Name:</label>
