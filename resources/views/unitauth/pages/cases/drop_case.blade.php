        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Drop case List</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
         ...
         <div class="col-lg-12 col-12">
            ...
            <div class="card-header text-center">
              <h3 class="card-title text-bold text-danger">Drop Case List</h3>
            </div>
             <!---===============================Filtering===============================================--->
             <div class="card-header text-center">
                <div class="form-row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <button input="submit" class="btn btn-secondary btn-sm filter-data-case" disabled><i class="fa fa-search" aria-hidden="true"></i> Find</button>
                    </div>
                </div>
            </div>
                <!---===============================Filtering===============================================--->
            ...
            <div class="card-body table-responsive">
              <div class=" text-center d-none" id="preloader">
                  ...
                  @include('unitauth.pages.cases.dropcase-table')
                  </div>
          </div>
            <!-- /.card-body -->
          </div>
