                            ...
                            <div class="card-body box-profile">
                                <div class="card-body box-profile">
                                    <div class="text-center">
                                        <img class="profile-user-img img-fluid img-circle" src="{{!empty(Auth::user()->image) ? asset(Auth::user()->image) : asset('/unit-user/image/avatar.png')}}" alt="User profile picture">
                                    </div>
                                ...
                                <div class="tab-content">
                                    <div class="active tab-pane" id="activity">
                                       ...
                                       <table class="table">
                                           ...
                                           <tr>
                                               <td>Unit : </td>
                                               <td>{{!empty(Auth::user()->Unit->name) ? Auth::user()->Unit->name : ''}}</td>
                                           </tr>
                                           <tr>
                                               <td>Role : </td>
                                               <td>{{!empty(Auth::user()->UnitRole->name) ? Auth::user()->UnitRole->name : ''}}</td>
                                           </tr>
                                           <tr>
                                               <td>Identification No : </td>
                                               <td>{{!empty(Auth::user()->ba_baf_no) ? Auth::user()->ba_baf_no : ''}}</td>
                                           </tr>
                                       </table>
                                        <!-- /.post -->
                                    </div>
                                    ...
                                    <div class="tab-pane" id="timeline">
                                        ...
                                        <form class="form" action="{{route('unitauth.unit.user.update')}}" method="Post" enctype="multipart/form-data">
                                            @csrf
                                    ...
                                    <div class="tab-pane" id="settings">
                                        ...
                                        <form class="form" action="{{route('unitauth.unit.user.passupdate')}}" method="Post" enctype="multipart/form-data">
                                            @csrf
