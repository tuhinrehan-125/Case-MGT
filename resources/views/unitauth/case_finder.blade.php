         ...
         <div class="col-lg-12 col-12">
                ...
                <div class="card-header text-center">
                    <div class="form-row">
                        ...
                        <div class="col-md-3 col-sm-6">
                           ...
                           <option value="packet_number">Packet Number</option>
                        ...
                        <div class="col-md-2 col-sm-6">
                            <button input="submit" class="btn btn-sm btn-info filter-data-case" disabled><i class="fa fa-search" aria-hidden="true"></i> Find</button>
                        </div>
                        <div class="col-md-2 col-sm-6">
                            <a href="#" id="scan" class="btn btn-sm btn-primary d-none" data-toggle="modal" data-target="#livestream_scanner">
                                Scan
                            </a>
                        </div>
                    </div>
            ...
            <div class="card-body table-responsive">
              <div id="tag_container">
                ...
                @include('unitauth.case_finder_table')
              </div>
            </div>
            <!-- /.card-body -->
...
<script type="text/javascript">
     $(document).ready(function(){
        datatable();
        function display(){
            // $("#case_finder tbody").addClass('d-none')

            $("#case_finder tbody").css("opacity", ".5");
                ...
                $("#field_name").on('change',function(){
                    ...
                    if(field=='packet_number'){
                        ...
                        if (result.codeResult.code){
                            ...
                            $('#query').val(result.codeResult.code);
                            Quagga.stop();
                            setTimeout(function(){ $('#livestream_scanner').modal('hide'); }, 1000);
                            for(var i=0; i<=2;i++){
                            getData(page='1',field, barcode)
                             }
                        }
                     });
                    }else{
    ...
    $('#forward_case_form').on('submit', function(event){
                ...
                $.ajax({
                    ...
                    success:function(data)
                    {
                        ...
                        $('.action-table').addClass('d-none')
                        $('.action-table').removeClass('d-block')
                        }else{
            ...
            $(document).on('click','.btn-forward',function (e) {
                ...
                $.ajax({
                    ...
                    success:function(data)
                    {
                        ...
                        $("#newcase-complete-subadmin").find("tr:gt(0)").remove();
        ...
        $('.subadmin-new-case-edit-submit').on('submit', function(event){
			...
			$(document).on('click','.drop-btn', function(event){
                event.preventDefault();
                var id=$(this).data('id');
                console.log(id)

                $.ajax({
                    url:"{{url('unitauth/case_drop')}}/"+id,
                    success:function(data)
                    {
