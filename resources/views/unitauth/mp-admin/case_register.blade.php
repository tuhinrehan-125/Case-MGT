                        ...
                        <div class="card-body">
                            ...
                            <form action="#" class="register-case-mp" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-sm-2 col-form-label">Packet No</label>
                                    <div class="col-sm-10">
                                        <div class="row">
                                            <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-2">
                                                <a href="javascript:void(0)" id="write-btn" class="btn btn-sm btn-success">
                                                    Write
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-sm-2 col-form-label">Case No</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="case_no" id="" placeholder="Case No">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="victim_name" id="" placeholder="Name">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="" class="col-sm-2 col-form-label">Mobile No</label>
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" name="victim_mb" id="" placeholder="Mobile No. Ex. 01888888888">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="" class="col-sm-2 col-form-label">Vehicle Reg. No</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="vehical_reg" id="" placeholder="Vehical Reg. No">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="" class="col-sm-2 col-form-label">Date offence</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control datepickeoff" name="date_off" value="<?php echo date('d-m-Y'); ?>">
                                    </div>
                                    <label for="" class="col-sm-1 col-form-label">Time</label>
                                    <div class="col-sm-3">
                                        <input type="time" class="form-control" name="time_off" value="<?php echo date('H:i'); ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="" class="col-sm-2 col-form-label">Date Disposal</label>
                                    <div class="col-sm-6">
                                ...
                                <fieldset class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <select style="width: 289px;" class="form-control selectdata" name="loc" id="" {{--onchange="if (this.value=='10000'){userselect.style.display='block'}else {userselect.style.display='none'};"--}}>
                                ...
                                <fieldset class="form-group">
                                    <div class="row">
                                        <label class="col-form-label col-sm-3 col-form-label">
                                            <!-- Victim -->Type of offender
                                        </label>
                                        <div class="col-sm-6">
