                    ...
                    <div class="col-lg-12 col-12">
                        <div class="card">
                            <div class="card-header text-center">
                                <h3 class="card-title text-danger text-bold">Register List</h3>
                            </div>
                            <!---===============================Filtering===============================================--->
                              <!---===============================Filtering===============================================--->
        <div class="card-header text-center">
                ...
                <div class="col-md-3 col-sm-6">
                    <button input="submit" class="btn btn-info filter-data-case" disabled><i class="fa fa-search" aria-hidden="true"></i> Find</button>
                            ...
                            <div class=" text-center d-none" id="preloader">
                                    ...
                                    @include('unitauth.mp-admin.casetable')
                                    </div>
                            </div>
                            <!-- /.card-body -->
                        </div>
                ...
                <div class="modal-body">
                    <form action="#" class="edit-case subadmin-new-case-edit-submit" method="POST">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <input type="hidden" class="mp-data"  name="id_mp" value="" >
{{--                            <tr>--}}
{{--                                <th>Name Of MP</th>--}}
{{--                                <td>--}}
