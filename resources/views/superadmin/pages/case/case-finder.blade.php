...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Case Finder</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{url('/superadmin/home')}}">Dashboard</a></li>
                        <li class="breadcrumb-item active">Case Finder</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                <div class="card col-md-12 col-12 col-sm-12">
                    <div class="card-header text-center">
                        <h3 class="card-title text-bold">Case Finder</h3>
                    </div>
                    <!---===============================Filtering===============================================--->
                    <div class="card-header text-center">
                        <div class="form-row">
                    ...
                    <div class="card-body table-responsive">
                        ...
                        <div id="tag_container">
                            @include('superadmin.pages.case.case-finder-table')
                        </div>
                    </div>
                </div>
...
<!-- Release Modal -->
<div class="modal fade bd-example-modal-sm" id="exampleaccept-release" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#accept-single').on('submit', function(e) {
            ...
            var id = $('#case_id').val();
            $.ajax({
                url: "superadmin/case-accept-single",
                method: "POST",
                data: new FormData(this),
                dataType: 'JSON',
                contentType: false,
